			...
			<li class="nav-item active"><a class="nav-link" href="#"
				...
				<div id="collapseUtilities2" class="collapse show"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item sidebar-clicked" href="/apa/hospital/medicheck/all/register/list.do">모든 건강검진 예약</a> <a
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	                ...
	                <div class="d-sm-flex align-items-center justify-content-between mb-4">
	                	<h1 class="h3 mb-0 text-gray-800 hansans" style="padding-top: 28px;">모든 건강검진 예약</h1>
	                </div>
