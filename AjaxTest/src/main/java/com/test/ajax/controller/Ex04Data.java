...
public class Ex04Data extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// req.getRequestDispatcher("/WEB-INF/views/ex04data.jsp");
	...
	private void m6(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 * "2023-10-26 09:40:00" }, { "seq": "5", "name": "홍길동", "pw": "1111", "memo":
		 * "메모입니다.", "regdate": "2023-10-26 09:40:00" } ]
		 * 
		 */
	...
	private void m5(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
		 * 
		 * JSON, JavaScript Object Notation - 객체 표기법 - 키와 값을 문자열("")로 표기 - 단, 숫자값은 "" 생략
		 * 가능 - 쌍따옴표만 가능, 홑따옴표 불가능 - 메소드 멤버 추가 불가능 - 자바의 DTO와 동일한 역할
		 * 
		 * { "키": "값", "키": "값", "키": "값" }
		 * 
		 * 
